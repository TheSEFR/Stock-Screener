...
1. Descarga fundamentales vía [yfinance](https://pypi.org/project/yfinance/)
   (P/E, crecimiento de beneficios, compras de insiders, recomendación de
   analistas).
2. Calcula un **score de 0 a 4** según los [criterios del ranking](#criterios-del-ranking).
3. Se queda con el **Top 10** y lo enriquece con noticias recientes traducidas
   al español, sentimiento heurístico de esas noticias y bancos con nota de
   compra fuerte.
4. Genera un **PDF** (`informe.pdf`) con portada, índice navegable, tabla
   resumen, descripción detallada por acción, noticias y un glosario con
   hipervínculos.
...
Cada acción suma un punto por cada condición que cumple (máximo 4):

| Check | Condición |
|---|---|
| **P/E bajo** | P/E de la acción por debajo del P/E medio del grupo analizado |
| **PEG bueno** | PEG < 1.5 |
| **Crecimiento** | Crecimiento de beneficios interanual > 15% |
| **Insider buying** | Algún directivo/accionista relevante compró acciones en los últimos 90 días |

El Top 10 con mayor score es el que se incluye en el informe.
...
| Métrica | Explicación |
|---|---|
| **P/E** | Precio / beneficio por acción (trailing). Se compara contra el promedio del grupo analizado, no en términos absolutos. Como referencia general: por debajo de 15 se suele considerar barato, entre 15 y 25 razonable, por encima de 25-30 caro / de alto crecimiento. |
...
| **Crecim.** | Crecimiento interanual del beneficio por acción (EPS), según estimación de Yahoo Finance. Por encima del 15% se considera fuerte. |
| **Insider buy** | Si algún directivo o accionista relevante compró acciones con su propio dinero en los últimos 90 días (dato de comunicados SEC Form 4, vía Yahoo Finance). |
